module ass_i2c_slave_rx #(
    ...
    //--------FSM---------------------
    wire rxempty, rxfull, rxempty_n;
    wire txempty, txfull, txempty_n;
    ...
    wire [7:0] rxwdata;
    wire load_data;
    wire init_ack, init_req, request_req, request_ack;
    ...
    assign txfifo_clr = init_req | init_ack;
    ...
    //-----------Packet FSM--------------------------
    ass_i2c_slave_pkt_ctrl #(
        .depth(depth))
    u_pkt_ctrl (
        .clk    (clk2),
        .rstb   (rstb),
        .rxempty    (rxempty),
        .rx_empty_n (rxempty_n),
        .txfull     (txfull),
        .init_req       (init_req),
        .request_req    (request_req),
