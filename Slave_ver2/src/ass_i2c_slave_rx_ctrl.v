...
always @(*) begin
    ...
    case (state)
        ...
        //st_rx_ack: state_n = (scl_falling && valid_phase) ? ack_next_state : st_rx_ack; 
        ...
        //st_tx_ack:  state_n = (scl_falling && sda_in == 1'b0) ? st_tx : st_tx_ack;
